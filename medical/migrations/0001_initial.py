    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collegiate_number', models.CharField(
                    max_length=20, blank=True, null=True, verbose_name='collegiate number'
                )),
                ('tin', models.CharField(
                    max_length=20, blank=True, null=True, verbose_name='taxpayer Identification Number (TIN)'
                )),
                ('last_name_optional', models.CharField(
                    max_length=30, blank=True, null=True, verbose_name='last name optional'
                )),
                ('address', models.TextField(blank=True, null=True, verbose_name='address')),
                ('phone_contact', models.TextField(blank=True, null=True, verbose_name='phone contact')),
                ('staff_type', models.CharField(
                    default=b'A', max_length=1,
                    choices=[(b'A', 'Administrative'), (b'D', 'Doctor')],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('peristaltic_conditions', models.TextField(
                    null=True, blank=True, verbose_name='peristaltic conditions'
                )),
                ...
                ('parents_status_health', models.TextField(
                    null=True, blank=True, verbose_name='parents status health'
                )),
                ('brothers_status_health', models.TextField(
                    null=True, blank=True, verbose_name='brothers status health'
                )),
                ('spouse_childs_status_health', models.TextField(
                    null=True, blank=True, verbose_name='spouse and childs status health'
                )),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_name_optional', models.CharField(
                    max_length=30, null=True, blank=True, verbose_name='last name optional'
                )),
                ...
                ('gender', models.CharField(
                    ...
                    choices=[(b'M', 'Male'), (b'F', 'Female')], verbose_name='gender'
                )),
                ('race', models.CharField(max_length=30, null=True, blank=True, verbose_name='race')),
                ('birth_date', models.DateField(
                    help_text='yyyy-mm-dd', null=True, blank=True, verbose_name='birth date'
                )),
                ('birth_place', models.CharField(max_length=50, null=True, blank=True, verbose_name='birth place')),
                ('decease_date', models.DateField(
                    help_text='yyyy-mm-dd', null=True, blank=True, verbose_name='decease date'
                )),
                ('tin', models.CharField(
                    max_length=20, null=True, verbose_name='taxpayer Identification Number (TIN)', blank=True
                )),
                ('ssn', models.CharField(
                    max_length=30, null=True, verbose_name='social Security Number (SSN)', blank=True
                )),
                ('health_card_number', models.CharField(
                    max_length=30, null=True, blank=True, verbose_name='health card number'
                )),
                ...
                ('insurance_company', models.CharField(
                    max_length=30, null=True, blank=True, verbose_name='insurance company'
                )),
                ('relatives', models.ManyToManyField(
                    related_name='_patient_relatives_+', to='medical.Patient', blank=True
                )),
                ('doctor_assigned', models.ForeignKey(
                    on_delete=models.deletion.SET_NULL, verbose_name='doctor allocated by quota',
