...
class TestPatientModel:
    ...
    def test_patient_age_calculation(self):
        ...
        patient = Patient.objects.create(
            first_name="Jane", last_name="Doe", birth_date=birth_date
        )
    ...
    def test_patient_gender_description(self):
        ...
        patient_male = Patient.objects.create(
            first_name="Male", last_name="Patient", gender="M"
        )
        patient_female = Patient.objects.create(
            first_name="Female", last_name="Patient", gender="F"
        )
    ...
    def test_patient_without_gender(self):
        ...
        patient = Patient.objects.create(first_name="NoGender", last_name="Patient")
